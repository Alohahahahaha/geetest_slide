var window = {
    'performance': {
        'timing': {
            "connectStart": new Date().getTime() - 30,
            "navigationStart": new Date().getTime(),
            "secureConnectionStart": 0,
            "fetchStart": new Date().getTime() - 30,
            "domContentLoadedEventStart": 1704791367649,
            "responseStart": new Date().getTime() - 37,
            "domInteractive": new Date().getTime() - 36,
            "domainLookupEnd": new Date().getTime() - 30,
            "responseEnd": new Date().getTime() - 52,
            "redirectStart": 0,
            "requestStart": new Date().getTime() - 37,
            "unloadEventEnd": new Date().getTime() - 90,
            "unloadEventStart": new Date().getTime() - 90,
            "domLoading": new Date().getTime() - 320,
            "domComplete": new Date().getTime() - 300,
            "domainLookupStart": new Date().getTime() - 30,
            "loadEventStart": new Date().getTime() - 53,
            "domContentLoadedEventEnd": new Date().getTime() - 50,
            "loadEventEnd": new Date().getTime() - 300,
            "redirectEnd": 0,
            "connectEnd": new Date().getTime() - 30
...
mwbxQ.$_Cg = function () {
    if (typeof mwbxQ.$_Au.$_DBGGJ === "function") {
        return mwbxQ.$_Au.$_DBGGJ.apply(mwbxQ.$_Au, arguments);
    } else {
        return mwbxQ.$_Au.$_DBGGJ;
    }
};
mwbxQ.$_DW = function () {
    if (typeof mwbxQ.$_BR.$_DBHGm === "function") {
        return mwbxQ.$_BR.$_DBHGm.apply(mwbxQ.$_BR, arguments);
    } else {
        return mwbxQ.$_BR.$_DBHGm;
    }
};
...
var U = function () {
    ...
    n[$_IAJA(236)][$_IBAP(272)] = function S() {
        ...
        return this[$_IBJS(275)][t + this[$_IBJS(275)][this[$_IBJS(287)]] & 255];
    };
    var r;
    var i;
    var o;
    ...
    if (i == null) {
        ...
        function c(t) {
            ...
            if ((_ = _ || 0) >= 256 || s <= o) {
                if (window[$_ICFi(230)]) {
                    _ = 0;
                    window[$_ICEJ(230)]($_ICFi(268), c, false);
                } else if (window[$_ICFi(235)]) {
                    _ = 0;
        ...
        if (window[$_IBAP(227)]) {
            window[$_IBAP(227)]($_IBAP(268), c, false);
        } else if (window[$_IAJA(243)]) {
            ...
            switch ($_DBCBg) {
                case mwbxQ.$_DW()[0][13]:
                    if (r == null) {
                        ...
                        while (o < s) {
                            var t = Math[$_IAJA(219)](Math[$_IBAP(21)]() * 65536);
                            i[o++] = t & 255;
                        }
                        r[$_IAJA(244)](i);
                        o = 0;
    ...
    function y(t, e, n) {
        ...
        for (; $_DBCDe !== mwbxQ.$_DW()[9][12];) {
            switch ($_DBCDe) {
                case mwbxQ.$_DW()[3][13]:
                    if (t != null) {
                        if ($_IBAP(83) == typeof t) {
                            this[$_IBAP(258)](t, e, n);
                        } else if (e == null && $_IBAP(51) != typeof t) {
    ...
    t = $_IAJA(200) == ht[$_IAJA(331)] ? (y[$_IAJA(236)][$_IBAP(301)] = function A(t, e, n, r, i, o) {
        ...
        while (--o >= 0) {
            ...
            var c = this[t++] >> 15;
            var u = a * _ + c * s;
            i = ((_ = s * _ + ((u & 32767) << 15) + n[r] + (i & 1073741823)) >>> 30) + (u >>> 15) + a * c + (i >>> 30);
            n[r++] = _ & 1073741823;
        }
        return i;
        ...
        while (--o >= 0) {
            ...
            var c = this[t++] >> 14;
            var u = a * _ + c * s;
            i = ((_ = s * _ + ((u & 16383) << 14) + n[r] + i) >> 28) + (u >> 14) + a * c;
            n[r++] = _ & 268435455;
        }
        return i;
    }, 28);
    ...
    y[$_IAJA(236)][$_IAJA(328)] = t * 2 - 52;
    var h;
    var f;
    var d = $_IAJA(382);
    var p = [];
    h = $_IBAP(40)[$_IAJA(120)](0);
    f = 0;
    for (; f <= 9; ++f) {
        p[h++] = f;
    }
    h = $_IBAP(123)[$_IAJA(120)](0);
    f = 10;
    for (; f < 36; ++f) {
        p[h++] = f;
    }
    h = $_IBAP(350)[$_IBAP(120)](0);
    f = 10;
    for (; f < 36; ++f) {
        p[h++] = f;
    }
    ...
    m[$_IAJA(236)][$_IBAP(342)] = function O(t) {
        ...
        $_IFDk.shift();
        var $_IFGe = $_IFDk[0];
        if (t[$_IFEo(345)] < 0 || t[$_IFEo(323)](this[$_IFEo(333)]) >= 0) {
            return t[$_IFEo(310)](this[$_IFFt(333)]);
        } else {
            return t;
        }
    };
    ...
    x[$_IAJA(236)][$_IAJA(342)] = function L(t) {
        ...
        var $_IIBX = $_IHIH[0];
        var e = w();
        t[$_IHJN(316)]()[$_IHJN(314)](this[$_IIAH(333)][$_IHJN(376)], e);
        e[$_IHJN(399)](this[$_IIAH(333)], null, e);
        if (t[$_IHJN(345)] < 0 && e[$_IIAH(323)](y[$_IHJN(370)]) > 0) {
    ...
    x[$_IAJA(236)][$_IAJA(383)] = function P(t) {
        ...
        if (t[$_IIJX(323)](this[$_IIJX(333)]) >= 0) {
    ...
    y[$_IBAP(236)][$_IBAP(340)] = function F(t) {
        ...
        $_JADZ.shift();
        var $_JAGj = $_JADZ[0];
        for (var e = this[$_JAFL(376)] - 1; e >= 0; --e) {
            t[e] = this[e];
        }
    ...
    y[$_IAJA(236)][$_IBAP(220)] = function z(t, e) {
        ...
        var a = 0;
        while (--o >= 0) {
            var _ = n == 8 ? t[o] & 255 : (r = o, (i = p[t[$_JBEX(120)](r)]) == null ? -1 : i);
            if (_ < 0) {
                ...
                } else if (a + n > this[$_JBEX(349)]) {
                    this[this[$_JBFs(376)] - 1] |= (_ & (1 << this[$_JBEX(349)] - a) - 1) << a;
                    this[this[$_JBFs(376)]++] = _ >> this[$_JBFs(349)] - a;
                } else {
                    this[this[$_JBEX(376)] - 1] |= _ << a;
                }
                if ((a += n) >= this[$_JBFs(349)]) {
                    a -= this[$_JBEX(349)];
                }
            }
        }
        if (n == 8 && (t[0] & 128) != 0) {
            this[$_JBEX(345)] = -1;
            if (a > 0) {
                this[this[$_JBFs(376)] - 1] |= (1 << this[$_JBFs(349)] - a) - 1 << a;
            }
        }
        this[$_JBFs(327)]();
        if (s) {
            y[$_JBEX(370)][$_JBEX(346)](this, this);
        }
    };
    y[$_IAJA(236)][$_IBAP(327)] = function X() {
        ...
        while (this[$_JBJv(376)] > 0 && this[this[$_JCAd(376)] - 1] == t) {
            --this[$_JBJv(376)];
        }
    };
    ...
    y[$_IBAP(236)][$_IBAP(321)] = function J(t, e) {
        ...
        if (n >= this[$_JDJo(376)]) {
            ...
            if (r > 0) {
                e[this[$_JEAZ(376)] - n - 1] |= (this[$_JDJo(345)] & o) << i;
            }
    ...
    y[$_IBAP(236)][$_IBAP(372)] = function Z(t) {
        ...
        var n = t[$_JFFj(376)] = e[$_JFEW(376)] * 2;
        while (--n >= 0) {
            t[n] = 0;
        }
        for (n = 0; n < e[$_JFEW(376)] - 1; ++n) {
            var r = e[$_JFEW(301)](n, e[n], t, n * 2, 0, 1);
            if ((t[n + e[$_JFFj(376)]] += e[$_JFFj(301)](n + 1, e[n] * 2, t, n * 2 + 1, r, e[$_JFEW(376)] - n - 1)) >= e[$_JFFj(380)]) {
                t[n + e[$_JFFj(376)]] -= e[$_JFEW(380)];
                t[n + e[$_JFEW(376)] + 1] = 1;
            }
        }
        if (t[$_JFFj(376)] > 0) {
            t[t[$_JFEW(376)] - 1] += e[$_JFEW(301)](n, e[n], t, n * 2, 0, 1);
        }
        t[$_JFEW(345)] = 0;
        t[$_JFFj(327)]();
    };
    y[$_IBAP(236)][$_IBAP(399)] = function Q(t, e, n) {
        ...
        if (!(r[$_JGAb(376)] <= 0)) {
            ...
            var u = o[c - 1];
            if (u != 0) {
                var l = u * (1 << this[$_JFJK(302)]) + (c > 1 ? o[c - 2] >> this[$_JGAb(328)] : 0);
    ...
    y[$_IBAP(236)][$_IBAP(393)] = function K() {
        ...
        var e = t & 3;
        if ((e = (e = (e = (e = e * (2 - (t & 15) * e) & 15) * (2 - (t & 255) * e) & 255) * (2 - ((t & 65535) * e & 65535)) & 65535) * (2 - t * e % this[$_JGFB(380)]) % this[$_JGFB(380)]) > 0) {
            return this[$_JGEd(380)] - e;
        } else {
            return -e;
        }
    };
    y[$_IAJA(236)][$_IBAP(303)] = function $_EF() {
        ...
        $_JGIA.shift();
        var $_JHBB = $_JGIA[0];
        return (this[$_JGJ_(376)] > 0 ? this[0] & 1 : this[$_JHAy(345)]) == 0;
    };
    ...
    y[$_IBAP(236)][$_IBAP(213)] = function $_GM(t) {
        ...
        if (s-- > 0) {
            if (a < this[$_JIAb(349)] && (n = this[s] >> a) > 0) {
                i = true;
                o = g(n);
            }
            while (s >= 0) {
    ...
    y[$_IBAP(236)][$_IBAP(395)] = function $_JK() {
        ...
        if (this[$_JJJC(376)] <= 0) {
            ...
            return this[$_JJJC(349)] * (this[$_JJJC(376)] - 1) + b(this[this[$_JJJC(376)] - 1] ^ this[$_BAAAF(345)] & this[$_JJJC(379)]);
        }
    };
    y[$_IAJA(236)][$_IBAP(310)] = function $_BAX(t) {
        ...
        if (this[$_BAAFe(345)] < 0 && e[$_BAAEs(323)](y[$_BAAEs(370)]) > 0) {
            t[$_BAAEs(346)](e, e);
        }
        return e;
    };
    ...
    E[$_IBAP(236)][$_IBAP(351)] = function ut(t, e) {
        ...
        $_BABIC.shift();
        var $_BACBQ = $_BABIC[0];
        if (t != null && e != null && t[$_BACAx(192)] > 0 && e[$_BABJr(192)] > 0) {
        ...
        } else if (console && console[$_BACAx(32)]) {
...
var V = function () {
    ...
    var i = r[$_BAEAV(366)] = {
        extend: function (t) {
            ...
            if (!(e[$_BAFFv(75)]($_BAFEt(244)) && this[$_BAFFv(244)] !== e[$_BAFEt(244)])) {
                e[$_BAFEt(244)] = function () {
        ...
        create: function () {
            ...
            t[$_BAGFG(244)][$_BAGEm(353)](t, arguments);
            return t;
        },
        init: function () {
    ...
    var u = r[$_BADJt(300)] = i[$_BAEAV(362)]({
        init: function (t, e) {
            ...
            if (e != undefined) {
                ...
                this[$_BAHJe(358)] = t[$_BAHJe(192)] * 4;
            }
        },
        concat: function (t) {
    ...
    var l = o[$_BAEAV(360)] = {
        parse: function (t) {
            ...
            for (var e = t[$_BAJFK(192)], n = [], r = 0; r < e; r++) {
                n[r >>> 2] |= (t[$_BAJEI(120)](r) & 255) << 24 - r % 4 * 8;
            }
    ...
    var a = r[$_BAEAV(304)] = i[$_BADJt(362)]({
        ...
        $_HFa: function (t) {
            ...
            var o = r / (i * 4);
            var s = (o = t ? Math[$_BBBFp(373)](o) : Math[$_BBBFp(242)]((o | 0) - this[$_BBBEZ(308)], 0)) * i;
            var a = Math[$_BBBEZ(322)](s * 4, r);
            if (s) {
                for (var _ = 0; _ < s; _ += i) {
                    this[$_BBBEZ(355)](n, _);
                }
        ...
        $_IEi: function (c) {
            ...
            return {
                encrypt: function (t, e, n) {
                    ...
                    e = l[$_BBFAc(266)](e);
                    if (!(n && n[$_BBFAc(344)])) {
                        (n = n || {})[$_BBEJx(344)] = l[$_BBEJx(266)]($_BBEJx(431));
                    }
    ...
    var p = (e[$_BAEAV(407)] = {})[$_BADJt(467)] = {
        pad: function (t, e) {
            ...
            $_BBHDw.shift();
            var $_BBHGB = $_BBHDw[0];
            for (var n = e * 4, r = n - t[$_BBHEh(358)] % n, i = r << 24 | r << 16 | r << 8 | r, o = [], s = 0; s < r; s += 4) {
                o[$_BBHFr(137)](i);
            }
    ...
    (function () {
        ...
        for (e = 0; e < 256; e++) {
            ...
            var s = t[o];
            var a = t[s];
            var _ = t[i] * 257 ^ i * 16843008;
            b[n] = _ << 24 | _ >>> 8;
            x[n] = _ << 16 | _ >>> 16;
            E[n] = _ << 8 | _ >>> 24;
            C[n] = _;
            _ = a * 16843009 ^ s * 65537 ^ o * 257 ^ n * 16843008;
            S[i] = _ << 24 | _ >>> 8;
            T[i] = _ << 16 | _ >>> 16;
            k[i] = _ << 8 | _ >>> 24;
            A[i] = _;
    ...
    var M = _[$_BADJt(401)] = g[$_BAEAV(362)]({
        $_IBY: function () {
            ...
            if (!this[$_BCAJI(459)] || this[$_BCAJI(460)] !== this[$_BCBAY(378)]) {
                for (var t = this[$_BCAJI(460)] = this[$_BCBAY(378)], e = t[$_BCAJI(389)], n = t[$_BCAJI(358)] / 4, r = (1 + (this[$_BCAJI(459)] = 6 + n)) * 4, i = this[$_BCBAY(465)] = [], o = 0; o < r; o++) {
                    if (o < n) {
                        i[o] = e[o];
                    } else {
                        var s = i[o - 1];
                        if (o % n) {
                            if (n > 6 && o % n == 4) {
                                s = y[s >>> 24] << 24 | y[s >>> 16 & 255] << 16 | y[s >>> 8 & 255] << 8 | y[s & 255];
                            }
                        } else {
                            s = y[(s = s << 8 | s >>> 24) >>> 24] << 24 | y[s >>> 16 & 255] << 16 | y[s >>> 8 & 255] << 8 | y[s & 255];
                            s ^= D[o / n | 0] << 24;
                        }
                        i[o] = i[o - n] ^ s;
                    }
                ...
                for (var a = this[$_BCBAY(498)] = [], _ = 0; _ < r; _++) {
                    ...
                    a[_] = _ < 4 || o <= 4 ? s : S[y[s >>> 24]] ^ T[y[s >>> 16 & 255]] ^ k[y[s >>> 8 & 255]] ^ A[y[s & 255]];
                }
            }
        },
        ...
        $_JEk: function (t, e, n, r, i, o, s, a) {
            ...
            for (var _ = this[$_BCCAv(459)], c = t[e] ^ n[0], u = t[e + 1] ^ n[1], l = t[e + 2] ^ n[2], h = t[e + 3] ^ n[3], f = 4, d = 1; d < _; d++) {
                var p = r[c >>> 24] ^ i[u >>> 16 & 255] ^ o[l >>> 8 & 255] ^ s[h & 255] ^ n[f++];
                var g = r[u >>> 24] ^ i[l >>> 16 & 255] ^ o[h >>> 8 & 255] ^ s[c & 255] ^ n[f++];
                var v = r[l >>> 24] ^ i[h >>> 16 & 255] ^ o[c >>> 8 & 255] ^ s[u & 255] ^ n[f++];
                var m = r[h >>> 24] ^ i[c >>> 16 & 255] ^ o[u >>> 8 & 255] ^ s[l & 255] ^ n[f++];
                c = p;
                u = g;
                l = v;
                h = m;
            }
            p = (a[c >>> 24] << 24 | a[u >>> 16 & 255] << 16 | a[l >>> 8 & 255] << 8 | a[h & 255]) ^ n[f++];
            g = (a[u >>> 24] << 24 | a[l >>> 16 & 255] << 16 | a[h >>> 8 & 255] << 8 | a[c & 255]) ^ n[f++];
            v = (a[l >>> 24] << 24 | a[h >>> 16 & 255] << 16 | a[c >>> 8 & 255] << 8 | a[u & 255]) ^ n[f++];
            m = (a[h >>> 24] << 24 | a[c >>> 16 & 255] << 16 | a[u >>> 8 & 255] << 8 | a[l & 255]) ^ n[f++];
            t[e] = p;
            t[e + 1] = g;
            t[e + 2] = v;
            t[e + 3] = m;
...
function result(params, uuid) {
    var u = new U()['encrypt'](uuid);
    var o = {
        "lang": "zh-cn",
        "userresponse": H(params['distance'], params['challenge']),
        "passtime": params['passtime'],
        "imgload": Math.floor(Math.random() * 50) + 98,
        "aa": W['prototype']['$_BBED'](W['prototype']['$_FD_'](params['track_list']), params['c'], params['s']),
        "ep": {
            "v": "7.9.2",
            "$_BIE": false,
            "me": true,
        ...
        "h9s9": "1816378497",
        "rp": X(params['gt'] + params['challenge']['slice'](0, 32) + params['passtime'])
    };
    var l = V['encrypt'](gt['stringify'](o), uuid);
    var h = m['$_FEX'](l);
    var w = h + u;
    return w
}
